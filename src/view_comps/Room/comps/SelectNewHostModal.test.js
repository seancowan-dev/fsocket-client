...
import SelectNewHostModal from './SelectNewHostModal';
...
describe('| Site Test Object |', () => {
  ...
  it('should render correctly in "debug" mode', () => {
    const component = shallow(<Provider {...store}><SelectNewHostModal debug /></Provider>);
    expect(component).toMatchSnapshot();
  });
  it('should render correctly in "production" mode', () => {
    const component = shallow(<Provider {...store}><SelectNewHostModal production /></Provider>);
    expect(component).toMatchSnapshot();
  });
});